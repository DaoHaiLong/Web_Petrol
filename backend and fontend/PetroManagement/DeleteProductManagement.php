...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_GET['del'])) {
        ...
        $proid = substr(base64_decode($_GET['del']), 0,-5);
        // Query implements
        $query = mysqli_query($con,"delete from Product where id='$proid'");
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="./UppdateProduct.php?proid=<?php echo base64_encode($row['id'] . $rno); ?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit">
                                                                <i class="fas fa-pencil-alt"></i></a>
                                                            <a href="./DeleteProductManagement.php?del=<?php echo base64_encode($row['id'] . $rno); ?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"> <i class="fas fa-trash"></i> </a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $cnt++;

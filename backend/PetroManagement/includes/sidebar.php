                    ...
                    <ul id="cats_drp" class="nav flex-column collapse collapse-level-1">
                        <li class="nav-item">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="AddCategory.php">Add</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="DeleteCategoryManagment.php">Manage</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul id="product_drp" class="nav flex-column collapse collapse-level-1">
                        <li class="nav-item">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="../DeleteProductManagement.php">Manage</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
